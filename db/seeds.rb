...
#PARENTS
w1 = Wcategory.find_or_create_by (title: 'Продукты питания')
w2 = Wcategory.find_or_create_by ( title: 'Алкогольные напитки')
w3 = Wcategory.find_or_create_by ( title: 'Продукты питания')
w4 = Wcategory.find_or_create_by ( title: 'Бытовая химия')
w5 = Wcategory.find_or_create_by ( title: 'Детские товары')
w6 = Wcategory.find_or_create_by ( title: 'Зоотовары')
w7 = Wcategory.find_or_create_by ( title: 'Косметика, парфюмерия')
w8 = Wcategory.find_or_create_by ( title: 'Медицинские товары')
w9 = Wcategory.find_or_create_by ( title: 'Табачные изделия')
w10 = Wcategory.find_or_create_by ( title: 'Строительные товары')
w11 = Wcategory.find_or_create_by ( title: 'Товары для дачи')
w12 = Wcategory.find_or_create_by ( title: 'Товары для дома')
...
w = w321.children.find_or_create_by(title: 'Готовые блюда мясные замороженные')
